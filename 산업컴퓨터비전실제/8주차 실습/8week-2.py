# -*- coding: utf-8 -*-
"""
Created on Wed Oct 27 21:32:10 2021
...
img0 = cv2.imread('c:/study/8week/Lena.png', cv2.IMREAD_COLOR)
img1 = cv2.imread('c:/study/8week/Lena_rotated.png', cv2.IMREAD_COLOR)
img1 = cv2.resize(img1, None, fx=0.75, fy=0.75)

img1 = np.pad(img1, ((64,)*2, (0,)*2), 'constant', constant_values=0)
imgs_list = [img0, img1]
